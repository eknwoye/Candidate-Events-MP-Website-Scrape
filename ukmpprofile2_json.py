...
# CODE REVISION & Author: Ejimofor Nwoye, Campaign Lab, Newspeak House, London, England, 20/05/2025
# The code logic passed Integration, Verification, Validation & Unit Tests (IVV&T), on Google Cloud (GCP) with the BigQuery analytical database warehouse service, in London on 13/05/2025

# File: ukmpprofile2_json.py
